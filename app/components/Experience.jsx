...
const EXPERIENCE = [
  ...
  },
  {
    ...
    current: false,
    bullets: [
      'Designed and shipped 15+ Java microservices and APIs on AWS (ECS, Lambda, API Gateway, DynamoDB, SQS), improving system fault tolerance through automated retries and reducing on-call alert volume.',
      ...
      'Stepped up as acting tech lead for current squad, maintaining sprint velocity and delivering every committed milestone on schedule.',
      'Diagnosed and resolved 10+ bugs including critical production defects impacting major banking clients, eliminating recurring customer escalations.',
      ...
      'Represented engineering in 15+ client discovery sessions with major financial institutions, shaping multiple product features and reducing requirements rework.',
