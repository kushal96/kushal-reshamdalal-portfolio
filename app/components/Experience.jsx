...
const EXPERIENCE = [
  {
    ...
    bullets: [
      ...
      'Built an event-driven Java microservice on AWS Lambda to process high-volume ACH transactions in real time, reducing fraud signal generation latency and enabling near-instant risk decisioning.',
      'Led architecture design sessions for enterprise financial clients, translating complex business requirements into scalable backend specifications and accelerating design-to-delivery timelines.',
      'Mentored engineers and co-op students through structured pairing and onboarding programs, improving team ramp-up speed and overall sprint throughput.',
      'Owned 24/7 on-call rotation via PagerDuty, triaging and resolving high-severity production incidents across distributed financial systems and driving down mean time to recovery.',
      'Led cross-functional war rooms during critical production outages, driving root-cause analysis and hotfix deployment while maintaining SLA uptime commitments for enterprise banking clients.',
      'Built technical runbooks, ADRs, and onboarding guides in Confluence, creating a self-service knowledge base that reduced new-hire ramp time and cut repeated senior engineer escalations.',
    ],
  },
  {
    company: 'Nasdaq',
    ...
    current: false,
    bullets: [
      'Designed and shipped 25+ Java microservices and REST APIs across AWS (ECS, Lambda, API Gateway, DynamoDB, SQS), improving system fault tolerance through automated retries and circuit breakers.',
      ...
      'Hardened the CI/CD release process by instituting multi-stage validation gates across Jenkins, Docker QA/staging, and RabbitMQ job checks — achieving zero failed production deployments over a 6-month release cycle.',
      ...
      'Diagnosed and resolved 30+ bugs including critical production defects impacting major banking clients, restoring system stability and eliminating recurring customer escalations.',
      'Automated AWS infrastructure provisioning across 10+ environments with Terraform, cutting deployment time and reducing cloud costs through right-sized resource allocation.',
      'Designed and ran load tests simulating peak payment processing volumes, uncovering critical bottlenecks that once resolved significantly improved system reliability under high load.',
      'Resolved high-severity backend failures for major banking clients, tracing root causes to misconfigured timeouts and unindexed queries — restoring normal API response times.',
    ],
  },
  {
    ...
    current: false,
    bullets: [
      'Rewrote slow Postgres queries as distributed Spark Scala jobs with intelligent caching, cutting fraud analytics runtime from 3 hours to under 2 minutes and enabling near-real-time fraud signal generation.',
      ...
      'Validated fraud detection microservice outputs against Champion vs. Challenger spreadsheets using Python, SQL, and Excel, ensuring full alignment with expected production baselines and supporting quarterly model refresh decisions.',
      'Migrated legacy fraud detection modules from a monolith to a service-based architecture, eliminating significant deprecated code and improving average feature delivery speed.',
      'Introduced cross-squad code review standards adopted across multiple engineering teams, reducing post-merge production defects and cutting average review turnaround to same-day.',
